...
function graphing()
    for i = 1:4
        ...
        plot(1./Temp[1:Int(floor(0.8 * end))],
        E_site[1:Int(floor(0.8 * end))],
        label = "E_site",
        xlabel = "T",
        ylabel = "E_site",
        ...
        dpi = 800,
        legend = :topleft,)
        plot!(EL4, 1/4, 100, label = "Low Temp expansion 4th order", linestyle = :dash)
        plot!(EL6, 1/4, 100, label = "Low Temp expansion 6th order", linestyle = :dash)
        plot!(EL8, 1/4, 100, label = "Low Temp expansion 8th order", linestyle = :dash)
        savefig("E_low_expan_beta.svg")
